...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "   pull(Request request)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	flag.BoolVar(&framed, "framed", true, "Use framed transport")
	flag.BoolVar(&useHttp, "http", true, "Use http")
	flag.Parse()
	...
	client := crawler.NewDataServiceClientFactory(trans, protocolFactory)
