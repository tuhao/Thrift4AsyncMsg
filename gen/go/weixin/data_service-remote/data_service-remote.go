...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  bool pushMsg( data)")
	fmt.Fprintln(os.Stderr, "  bool pushNews( data)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := weixin.NewDataServiceClientFactory(trans, protocolFactory)
	...
	case "pushMsg":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "PushMsg requires 1 args")
			flag.Usage()
		}
		arg13 := flag.Arg(1)
		...
		containerStruct0 := weixin.NewPushMsgArgs()
		...
		value0 := argvalue0
		fmt.Print(client.PushMsg(value0))
		fmt.Print("\n")
		break
	case "pushNews":
		if flag.NArg()-1 != 1 {
			fmt.Fprintln(os.Stderr, "PushNews requires 1 args")
			flag.Usage()
		}
		arg19 := flag.Arg(1)
		...
		containerStruct0 := weixin.NewPushNewsArgs()
		...
		argvalue0 := containerStruct0.Data
		value0 := argvalue0
		fmt.Print(client.PushNews(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
